import { state } from '../app-state.js';
        ...
        // ============================================================
        // ⚠️⚠️⚠️ 严重警示（2026-08-17，勿删）⚠️⚠️⚠️
        // 本文件所有「竞昨 / 平行 / 高光」函数只允许统计「当日 9:25 正式名单
        // （_getAuctionWatchlistSet(date) watchlist 成员）」内的股票。
        // 严禁把 _auctionMemCache 中的 market_metrics 影子行（numcat 抓到的数据、
        // 不在正式名单的股票）混入计算——8/14 曾因此把竞昨全集从 16 撑到 21，
        // 导致 8/17 观察组错误继承 21 只（应为 16），竞昨数/蓝色高光/观察组三数打架。
